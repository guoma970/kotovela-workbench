...
const mismatches = rows
  .filter(({ fixture, row }) => fixture.expectation.category !== row.category || fixture.expectation.reason !== row.reason || fixture.expectation.success !== row.success)
  .map(({ fixture, row }) => ({ id: fixture.id, expected: fixture.expectation, actual: { category: row.category, reason: row.reason, success: row.success } }))
