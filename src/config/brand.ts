...
export const BRAND_NAME = APP_MODE === 'internal' ? '言町科技 KOTOVELA' : 'KOTOVELA OSS Demo'

export const INTERNAL_PRODUCT_TITLE = APP_MODE === 'internal' ? 'OpenClaw 协作驾驶舱' : BRAND_NAME

export const brandConfig = {
  name: BRAND_NAME,
  title: APP_MODE === 'internal' ? `${BRAND_NAME} · ${INTERNAL_PRODUCT_TITLE}` : BRAND_NAME,
  appTitle: APP_MODE === 'internal' ? `${BRAND_NAME} · ${INTERNAL_PRODUCT_TITLE}` : BRAND_NAME,
  description:
    APP_MODE === 'internal'
      ? '言町科技 KOTOVELA · OpenClaw 协作驾驶舱'
