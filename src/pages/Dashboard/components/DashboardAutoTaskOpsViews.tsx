    ...
    <>
      ...
      <section className="scheduler-overview-card">
        ...
        <div className="scheduler-overview-grid scheduler-overview-grid-ops">
          ...
          <div className="scheduler-overview-metric is-failed"><span>卡住</span><strong>{riskSummary.blocked}</strong></div>
            ...
            <div className="scheduler-decision-list">
              {domainLoadSummary.length ? domainLoadSummary.map((entry, index) => (
                <article className="scheduler-decision-item" key={`${entry.domain}-${index}`}>
                  ...
                  <small>卡住 {entry.blocked} · 待人工处理 {entry.needHuman}</small>
                </article>
    ...
    <>
      <section className="scheduler-overview-card">
        ...
        <div className="scheduler-overview-grid">
          ...
          <div className="scheduler-overview-metric is-failed"><span>卡住</span><strong>{executionStatusSummary.blocked}</strong></div>
      ...
      <section className="scheduler-queue-card">
        ...
        <div className="scheduler-queue-grid">
          ...
          <div className="scheduler-lane">
            <div className="scheduler-lane-head"><h4>卡住</h4><span>{executionStatusSummary.blocked}</span></div>
            <div className="scheduler-lane-list">{blockedPoolTasks.length ? blockedPoolTasks.map((item, index) => renderTaskCard(item, 'paused', index)) : <div className="auto-task-empty">暂无卡住任务</div>}</div>
          </div>
          <div className="scheduler-lane">
