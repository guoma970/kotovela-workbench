...
const getNavItems = (isInternal: boolean) =>
  isInternal
    ? [
        ...
        { group: '调度系统', to: '/auto-tasks', step: 5, label: 'Scheduler 调度', note: '执行控制 · 队列调度' },
    ...
    : [
        ...
        { group: 'Scheduling', to: '/auto-tasks', step: 5, label: 'Scheduler', note: 'Execution control and queue' },
