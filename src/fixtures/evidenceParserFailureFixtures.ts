...
export const evidenceParserFailureFixtures: EvidenceParserFailureFixture[] = [
  ...
  {
    id: 'fixture-same-account-different-source',
    title: 'same account different source line',
    detail: 'when source_line diverges from account_line, room drift must not be swallowed by account bucket',
    source: 'fixture',
    textParts: ['route decision', 'same account', 'different source room'],
    signalParts: ['account_line=yanfami_official', 'source_line=kotovela_official'],
    expectation: { category: 'no_object_match', success: false, reason: 'signals_present_but_unmapped', match_source: 'signal_map_room', match_confidence: 'low' },
  },
  {
    id: 'fixture-same-source-different-content',
    title: 'same source different content line',
    detail: 'when account/source are aligned but content_line carries the split, keep it in content bucket',
    source: 'fixture',
    textParts: ['route decision', 'same source', 'different content line'],
    signalParts: ['account_line=yanfami_official', 'source_line=yanfami_official', 'content_line=floor_heating'],
